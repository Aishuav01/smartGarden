...
String msg = "GET /update?key=GEZTZAQ3SWG5CYGW";     // ThingSpeak API key
String API_KEY = "F4ZOSRY4UL01PY90";  //Thingtweet
SoftwareSerial esp8266(8,9);     //Rx,Tx
LiquidCrystal lcd(12,11,5,4,3,2);
//DHT dht;

 #define DHTTYPE DHT11 
DHT dht(DHT11_PIN, DHTTYPE);// Initialize the DHT sensor
...
switch (chk)
{
  case DHTLIB_OK://DHTLIB_OK original
  lcd.print("OK");
  lcd.print(" ");
  break;
case DHTLIB_ERROR_CHECKSUM://DHTLIB_ERROR_CHECKSUM original
  lcd.print("Checksum error");
  lcd.print(" ");
  break;
case DHTLIB_ERROR_TIMEOUT://DHTLIB_ERROR_TIMEOUT origi
...
delay(3000);
 ...
 boolean postTweet( String tweet) {
  ...
  String tweetData = "api_key=F4ZOSRY4UL01PY90";
  tweetData += API_KEY;
